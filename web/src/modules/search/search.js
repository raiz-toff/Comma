...
export async function filterShifts(filters = {}) {
  ...
  return rows.filter((row) => {
    ...
    if (filters.minOrders != null && num(row.deliveryCount) < num(filters.minOrders)) return false;
    if (filters.maxOrders != null && num(row.deliveryCount) > num(filters.maxOrders)) return false;
