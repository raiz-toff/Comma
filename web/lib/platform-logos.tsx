...
/** Platform logo — 16×16 by default, tinted by `currentColor` from parent */
export function PlatformLogo({ id, size = 16 }: { id: string; size?: number }) {
