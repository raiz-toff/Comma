...
- **Light mode**: Comma can now be light. Out of the box it follows your phone — set your phone to dark for a night shift and Comma goes dark with it. You can pin it either way under **Settings → Appearance → Theme**, which offers *Auto*, *Light* and *Dark*. It changes the moment you tap it — nothing to save, nothing to restart. Your route maps switch over too, so a light screen no longer wraps a dark map.
