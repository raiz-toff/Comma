...
1. Open [the latest release](https://github.com/raiz-toff/Comma/releases/latest) on GitHub and download the APK.
...
Open [comma-psi.vercel.app](https://comma-psi.vercel.app) in any modern browser. It runs as-is, with nothing to install. You should install it as a PWA anyway — that gives it its own window, a home-screen or dock icon, and full offline use, so it behaves like an app rather than a tab.
...
- [Quick Start](../getting-started/quick-start.md) — set up in about five minutes
- [Try Comma with demo data](./demo-mode.md) — explore before you commit
